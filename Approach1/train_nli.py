...
parser.add_argument("--minlr", type=float, default=1e-8, help="minimum lr")
...
print("Save Encoder")
torch.save(nli_net.encoder,os.path.join(params.encoderdir, params.encodermodelname))
#torch.save(nli_net.encoder,os.path.join(params.outputdir, "anand"))
print("--%s --" % params.encodermodelname)
